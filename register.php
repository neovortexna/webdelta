...
<link rel="stylesheet" href="assets/css/style.css?v=1788341600">
</head>
...
<div class="auth-shell">
    ...
    <div class="auth-panel">
        <form class="auth-form" method="POST" action="register.php" autocomplete="off">
            ...
            <div class="alert-inline" style="background:var(--paper-100); color:var(--ink-600); border:1px solid var(--line);">
